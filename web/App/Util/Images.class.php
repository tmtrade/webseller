...
class Images {
    ...
    var $saveDir = "/Static/upload/avatar/";      //保存目录
    ...
    function thumb($image, $is_save = true, $suofang = 0, $type = '', $maxWidth = 400, $maxHeight = 400, $interlace = true) {
    	...
    	if ($info !== false) {
    	    ...
    	    if ($suofang != 1) {
                ...
                if (function_exists("ImageCopyResampled")){
            		imagecopyresampled($thumbImg01, $thumbImg, 0, 0, $_POST['x'], $_POST['y'], 100, 100, $_POST['w'], $_POST['h']);
            		imagecopyresampled($thumbImg02, $thumbImg, 0, 0, $_POST['x'], $_POST['y'], 48, 48, $_POST['w'], $_POST['h']);
                }else{
                    imagecopyresized($thumbImg01, $thumbImg, 0, 0, $_POST['x'], $_POST['y'], 100, 100, $_POST['w'], $_POST['h']);
                    imagecopyresized($thumbImg02, $thumbImg, 0, 0, $_POST['x'], $_POST['y'], 48, 48, $_POST['w'], $_POST['h']);
                }
